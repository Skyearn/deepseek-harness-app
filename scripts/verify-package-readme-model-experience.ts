...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/git/git': { kind: 'indirect', reason: 'The seam delegates model rendering to dsh-tool-git.' },
  'packages/git/git-local': { kind: 'indirect', reason: 'The local backend delegates model rendering to dsh-tool-git.' },
